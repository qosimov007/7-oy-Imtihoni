...
const RecommendProducts = () => {
  ...
  while (randomProducts.length < 3) {
    ...
    // agar randomProduct qiymati allaqachon randomProducts
    // massivida mavjud bo'lmasa, uning qiymati randomProducts massiviga
    // qo'shiladi. Bu usul, "randomProducts" massivining
    // ichiga takrorlanmas elementlar qo'shishga imkoniyat beradi
    // bor hil bo'lib qolmasligi uchun
